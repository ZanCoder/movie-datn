...
values	(N'sK0rpion', 'nhatphay2099@gmail.com', null, 1)
go
...
-- movie 1
insert into [movie]([title], [quality], [duration_min], [poster], [cover], [description], 
					[release_date], [productions], [casts], [budget], [vip],
					[imdb_rate], [trailer], [type])
values	('John Wick', 1, '101 min', 'https://iili.io/D81t8x.jpg', 'https://iili.io/D8EK8v.jpg', 'Ex-hitman John Wick comes out of retirement to find the gangsters that required everything from him.',
...
insert into [movie]([title], [quality], [duration_min], [poster], [cover], [description], 
					[release_date], [productions], [casts], [budget], [vip],
					[imdb_rate], [trailer], [type])
values	('Spider-Man: Into the Spider-Verse', 1, '117 min', 'https://iili.io/D81Q3b.jpg', 'https://iili.io/D81DyQ.jpg', 'Miles Morales is juggling his lifetime and also being a spiderman. When Wilson"Kingpin" Fisk uses a super collider, others from across the SpiderVerse are hauled to the measurement.',
...
insert into [movie]([title], [quality], [duration_min], [poster], [cover], [description], 
					[release_date], [productions], [casts], [budget], [vip],
					[imdb_rate], [trailer], [type])
values	('Joker', 1, '118 min', 'https://iili.io/D8EHn1.jpg', 'https://iili.io/D81O4s.jpg', 'Throughout the 1980s, while becoming an infamous crime figure, there is a comedian driven insane and turns to a life of chaos and crime in Gotham City.',
...
insert into [movie]([title], [quality], [duration_min], [poster], [cover], [description], 
					[release_date], [productions], [casts], [budget], [vip],
					[imdb_rate], [trailer], [type])
values	('Kingsman: The Secret Service ', 1, '129 min', 'https://iili.io/D814Z7.jpg', 'https://iili.io/D8EJMF.jpg', 'A spy company that recruits an unrefined but promising street kid into the agency training regime as a world wide threat''s narrative stems out of a tech ace.',
...
insert into [movie]([title], [quality], [duration_min], [poster], [cover], [description], 
					[release_date], [productions], [casts], [budget], [vip],
					[imdb_rate], [trailer], [type])
values	('Ready Player One', 1, '140 min', 'https://iili.io/D81iGe.jpg', 'https://iili.io/D81XjI.jpg', 'After the founder of a well known video game system expires, there is a virtual competition established to compete due to his or her fortune.',
...
insert into [movie]([title], [quality], [duration_min], [poster], [cover], [description], 
					[release_date], [productions], [casts], [budget], [vip],
					[imdb_rate], [trailer], [type])
values	('Ted', 1, '107 min', 'https://iili.io/D81hQt.jpg', 'https://iili.io/D81vaf.jpg', 'John Bennett, a person whose of earning his teddy bear to 15, youth wish came true has to pick between keeping the association with his girl friend or the bear.',
...
insert into [movie]([title], [quality], [duration_min], [poster], [cover], [description], 
					[release_date], [productions], [casts], [budget], [vip],
					[imdb_rate], [trailer], [type])
values	('Rush Hour', 1, '98 min', 'https://iili.io/D81muV.jpg', 'https://iili.io/D81pwB.jpg', 'When hongkong Inspector Lee is summoned into Los Angeles to investigate a kidnapping, the FBI doesn''t want any outside support and assigns Lee to distract from the situation. Not satisfied to watch the activity from the sidelines, Carter and Lee form an unlikely venture and inquire into the case themselves.',
...
insert into [movie]([title], [quality], [duration_min], [poster], [cover], [description], 
					[release_date], [productions], [casts], [budget], [vip],
					[imdb_rate], [trailer], [type])
values	('The Batman', 1, '176 min', 'https://iili.io/D81rjS.jpg', 'https://iili.io/D81Zaj.jpg', 'In his second year fighting crime, Batman finds corruption in Gotham City that involves his own family. He also faces a serial killer known as the Riddler.',
...
insert into [movie]([title], [quality], [duration_min], [poster], [cover], [description], 
					[release_date], [productions], [casts], [budget], [vip],
					[imdb_rate], [trailer], [type])
values	('Mortal Kombat Legends: Scorpion’s Revenge', 1, '80 min', 'https://iili.io/D8E3Fa.jpg', 'https://iili.io/D81EYv.jpg', 'Hanzo Hasashi is exiled to the tortuous Netherrealm after the heinous slaughter of his family by the stone-cold mercenary Sub-Zero. In exchange for his servitude to the sinister Quan Chi, he is given the opportunity to avenge his family – and is resurrected asScorpion, a lost soul bent on vengeance. Back on Earthrealm, Lord Raiden assembles a group of elite warriors – Shaolin monk Liu Kang, Special Forces officer Sonya Blade, and action star Johnny Cage – an unlikely band of heroes with only one chance to save humanity. To accomplish this, they must defeat Shang Tsung''s horde of Outworld gladiators and take control of the Mortal Kombat tournament.',
...
insert into [movie]([title], [quality], [duration_min], [poster], [cover], [description], 
					[release_date], [productions], [casts], [budget], [vip],
					[imdb_rate], [trailer], [type])
values	('El Camino: A Breaking Bad Movie', 1, '123 min', 'https://iili.io/D8Eq9R.jpg', 'https://iili.io/D81WTN.jpg', 'In the wake of the dramatic escape from captivity, Jesse Pinkman must come to terms with his past in order to forge some kind of future.',
...
insert into [movie]([title], [quality], [duration_min], [poster], [cover], [description], 
					[release_date], [productions], [casts], [budget], [vip],
					[imdb_rate], [trailer], [type])
values	('Pixels', 1, '105 min', 'https://iili.io/D81s6u.jpg', 'https://iili.io/D81gu2.jpg', 'Game pros are recruited by the military to fight game characters that have attacked newyork.',
...
insert into [movie]([title], [quality], [duration_min], [poster], [cover], [description], 
					[release_date], [productions], [casts], [budget], [vip],
					[imdb_rate], [trailer], [type])
values	('A Silent Voice', 1, '130 min', 'https://iili.io/D8EBup.jpg', 'https://iili.io/D81Mpp.jpg', 'As she''s deaf, shouya Ishida starts raping the brand newest girl in class, Shouko Nishimiya. But since the stink continues, the rest of the class starts to turn because of his lack of empathy Shouya. If they leave elementary school, Shouko and Shouya usually do not talk with each other again... before a young, more educated Shouya, tormented by his past behaviour, decides he must see Shouko yet again. He wants to atone for his sins, but is it already too late...?',
...
insert into [movie]([title], [quality], [duration_min], [poster], [cover], [description], 
					[release_date], [productions], [casts], [budget], [vip],
					[imdb_rate], [trailer], [type])
values	('The Sandman', 1, '45 min', 'https://iili.io/D8jBg1.jpg', 'https://iili.io/D8jndF.jpg', 'Morpheus, the King of Dreams, embarks on a journey across worlds to recover what was stolen from him and reclaim his power after years of imprisonment.',
...
insert into [movie]([title], [quality], [duration_min], [poster], [cover], [description], 
					[release_date], [productions], [casts], [budget], [vip],
					[imdb_rate], [trailer], [type])
values	('Tekken: Bloodline', 1, '25 min', 'https://iili.io/D8jl7n.jpg', 'https://iili.io/D8j1mG.jpg', 'A hot-tempered fighter trains under his fanatical grandfather after losing his house to a powerful enemy.',
...
insert into [movie]([title], [quality], [duration_min], [poster], [cover], [description], 
					[release_date], [productions], [casts], [budget], [vip],
					[imdb_rate], [trailer], [type])
values	('Loki', 1, '52 min', 'https://iili.io/D8jMX4.jpg', 'https://iili.io/D8jVLl.jpg', 'After seizing the Tesseract during the events of "Avengers: Endgame," a parallel Loki is transported to the enigmatic Time Variance Authority, a governmental institution that exists outside of time and space and oversees the timeline. They give Loki the option of being eliminated from existence as a "time variation" or assisting in repairing the timeline and preventing a greater threat.',
