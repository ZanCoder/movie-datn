(function($) {
  ...
  $(function() {
    ...
    if ($("#transaction-history").length) {
      var areaData = {
        labels: ["Visa", "Mastercard", "American Express", "Discover", "JCB"],
        datasets: [{
            data: [$("#transaction-history").attr('data-visa'), $("#transaction-history").attr('data-mastercard'), 
            		$("#transaction-history").attr('data-american'), $("#transaction-history").attr('data-discover'), 
            		$("#transaction-history").attr('data-jcb')],
            backgroundColor: [
              "#8F5FE8","#00d25b","#ffab00","#0090E7","#FC424A"
            ]
          }
        ]
      };
      ...
      var transactionhistoryChartPlugins = {
        beforeDraw: function(chart) {
          ...
          var text = '$' + $("#transaction-history").attr('data-total'), 
